...
var clearCache = require('../../lib/bakup/server').clearCache;
...
describe('clearCache', function() {
	...
	beforeEach(function () {
		detailsCol.remove({});
		stubs = [
			sinon.stub(retailerScripts, 'get').returns(Promise.resolve([
				{
					retailerFile: 'path/to/script1',
					url: 'url1',
					status: true
				},
				{
					retailerFile: 'path/to/script3',
					url: 'url3',
					status: true
				}
			]))
